...
class PCA:
    ...
    def fit(self, X):
        ...
        # self.components_ = sorted_eigenvectors[:,0:self.n_components]
        # self.explained_variance_ = sorted_eigenvalue[0:self.n_components]
        # self.explained_variance_ratio_ = self.explained_variance_ / np.sum(sorted_eigenvalue)
        # Out of memory...
        # The code above refers to https://github.com/Loping151/freshman_archive/blob/main/2022Spring/AIHomework/Lo_clustering_with_dr.py
        # But plz be careful: that is also my own implementation.
