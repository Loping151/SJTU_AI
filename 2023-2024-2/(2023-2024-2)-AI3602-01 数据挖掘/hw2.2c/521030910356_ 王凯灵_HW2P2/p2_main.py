...
def parse_args():
    ...
    parser.add_argument(
        "--base_path",
        type=str,
        default="/root/ai3602/p2_CommunityDetection",
    )
    parser.add_argument(
        "--truth_path",
        type=str,
        default="p2_data/label_reference.csv",
    )
    parser.add_argument(
        "--output_csv_path",
        type=str,
        default="p2_data/p2_prediction.csv",
    )
...
def main(args):
    TRUTH_PATH = os.path.join(args.base_path, args.truth_path)
    OUTPUT_CSV_PATH = os.path.join(args.output_csv_path)
