...
def main():
    args = parse_args()
    if not os.path.exists(os.path.dirname(args.testset_path)):
        args.testset_path = args.testset_path.replace('ai3602', 'workspace')
        args.output_csv_path = args.output_csv_path.replace('ai3602', 'workspace')
        args.reference_csv_path = args.reference_csv_path.replace('ai3602', 'workspace')
    print(args)
