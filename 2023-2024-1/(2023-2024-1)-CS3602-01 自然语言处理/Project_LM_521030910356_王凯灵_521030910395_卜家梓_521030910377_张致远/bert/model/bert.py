...
class Bert_WMM(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.bert_config = BertConfig.from_pretrained('../pretrain_models/bert_wwm/bert_config.json')
        self.tokenizer = BertTokenizer.from_pretrained('../pretrain_models/bert_wwm/vocab.txt')
        self.bertmodel = BertModel.from_pretrained('../pretrain_models/bert_wwm/pytorch_model.bin', config=self.bert_config)
